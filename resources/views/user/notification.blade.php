    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <a class="font-weight-bolder mb-0" href="{{route('home')}}">Return Home</a>
        </nav>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">{{$event->pivot->status}}</span>
                      </td>
                      <td class="align-middle text-center text-sm">
                      ...
                      <form action="{{ route('downloadTicket', ['event' => $event->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        @if($event->pivot->status == 'reserved')
                        <button type="button" class="btn btn-primary btn-sm" >Ticket Already Dowloaded</button>
                        @elseif ($event->pivot->status == 'accepted')
                        <button type="submit" class="btn btn-primary btn-sm" >Download Ticket</button>
                        @endif
                    </form>
                      </td>
                    </tr>
