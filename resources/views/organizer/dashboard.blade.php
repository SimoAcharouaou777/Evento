                ...
                <div>
                  ...
                  <fieldset>
                    ...
                    <div class="container mt-4">
                      <p>Do you want this ticket to be generated automatically?</p>
                      
                      <div class="form-check">
                          <input class="form-check-input" type="radio" name="ticketOption" id="autoGenerate" value="auto" checked>
                          <label class="form-check-label" for="autoGenerate">Yes</label>
                      </div>
                  
                      <div class="form-check">
                          <input class="form-check-input" type="radio" name="ticketOption" id="manualGenerate" value="manual">
                          <label class="form-check-label" for="manualGenerate">No</label>
                      </div>
                  </div>
                  </fieldset>
