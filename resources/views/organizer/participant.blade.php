  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{route('home')}}" >
        <img src="{{asset('assets/img2/logo-ct-dark.png')}}" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  active" href="{{route('organizer.index')}}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{route('partisipant')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Partisipant</th>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0 "> {{$user->status}}</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$partisipant->title}}</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{ $partisipant->available_seats}}</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class=>{{$partisipant->location}}</span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="badge badge-sm bg-gradient-success">{{$user->pivot->status}}</p>
                      </td>
                      <td class="d-flex gap-2">
                        <form action="{{route('acceptRequest',['event' => $partisipant->id, 'user' => $user->id])}}" method="post">
                          @csrf
                          @method('PUT')
                          <input type="hidden" name="event" value="{{ $partisipant->id }}">
