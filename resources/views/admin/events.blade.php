                        ...
                        <tr>
                          ...
                          <td class="d-flex gap-2">
                            <form action="{{route('admin_events.update', $event->id)}}" method="post">
                              @csrf
                              @method('PUT')
                              <button type="submit" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editemodal{{ $event->id }}">
                                Accept
                              </button>
                            </form>
                      
                          <form action="{{route('admin_events.destroy', $event->id)}}" method="post">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-primary btn-sm" >Refuse</button>
                        </form>
                          </td>
                        </tr>
                        @endforeach
