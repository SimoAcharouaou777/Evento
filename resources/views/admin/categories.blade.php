    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('admin_events.index')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <form action="{{route('category.destroy', $category->id)}}" method="post">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-primary btn-sm" >Delete Category</button>
                    </form>
                      </td>
                    </tr>
                    @endforeach
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel">Creat a new category</h1>
                ...
                <div class="modal-body">
                  <div>
                    ...
                    <form id="addBookForm" action="{{route('category.store')}}" method="post" >
                    ...
                    <fieldset>
                        ...
                        <div class="mb-3">
                            <label for="tite" class="form-label">category name</label>
        ...
        <div class="modal-body">
          <form action="{{route('category.update', $category->id)}}" method="post">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" value="{{$category->name}}" id="category-name" name="name">
            </div>
            <div class="mb-3">
